...
class Flower(models.Model):
    ...
    wiki_page = models.URLField(default="https://www.wikipedia.org/", null=True, name='Wikipedia', unique_for_date="delivered_at")
    name = models.CharField(max_length=64, unique=True, null=True)


class Bouquet(models.Model):
    shop = models.Manager()
    fresh_period = models.DurationField(default=timedelta(days=5), null=True, help_text="Use this field when you need "
